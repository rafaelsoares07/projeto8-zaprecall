...
export default function Pergunta(props) {
    ...
    return (
        ...
        <>
            ...
            {estado === 'stage3' ? <MostraTelaZap btnRespostas={props.btnRespostas} setBtnRespostas={props.setBtnRespostas} qtdCertas={props.qtdCertas} setQtdCertas={props.setQtdCertas} qtdRespostas={props.qtdRespostas} setQtdRespostas={props.setQtdRespostas} estado={estado} setEstado={setEstado} formatacaoCard={formatacaoCard} setFormatacaoCard={setFormatacaoCard} propriedades={props} /> : ' '}
